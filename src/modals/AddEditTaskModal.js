    ...
    >
      ...
      >
        ...
        <div className="mt-8 flex flex-col space-y-3">
          ...
          <button
            className="bg-custom-gradient w-full items-center dark:text-[#635fc7] dark:bg-white  text-white bg-[#635fc7] py-2 rounded-full "
            onClick={() => {
              setSubtasks((state) => [
                ...state,
                { title: "", isCompleted: false, id: uuidv4() },
        ...
        <div className="mt-8 flex flex-col space-y-3">
          ...
          <button
            ...
            className="bg-custom-gradient w-full items-center text-white bg-[#635fc7] py-2 rounded-full "
          >
